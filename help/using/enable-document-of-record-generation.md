...
この [Automated forms conversionサービス（AFCS）](/help/using/introduction.md) では、次のソースフォームがアダプティブフォームに変換されます。
...
非インタラクティブPDFフォームをAutomated forms conversionサービス（AFCS）のソースフォームとして使用している場合は、次のことができます。
...
automated forms conversionサービス（AFCS）のソースフォームとして Acro フォームまたは XFA ベースのPDFフォームを使用している場合は、次のことができます。
