---
title: 既知の問題
description: 自動フォーム変換サービス（AFCS）に関する既知の問題と制限事項
...
AEM Forms自動フォーム変換サービス（AFCS）の使用を開始する前に、次の既知の問題と制限事項を確認してください。
...
* AEM 6.5 Formsでは、一部の設定において、入力フォームの複数列レイアウトの自動検出がサポートされていません。
